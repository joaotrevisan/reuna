            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="form-group col-md-1">
                      ...
                      <input type="text" class="form-control" name="matricula['falta_seg']" style="text-transform: uppercase;" value="<?php echo $matricula['falta_seg']; ?>">
                    </div>
                      
                    <div class="form-group col-md-1">
                      <label for="nome">TER</label>
                      <input type="text" class="form-control" name="matricula['falta_ter']" style="text-transform: uppercase;" value="<?php echo $matricula['falta_ter']; ?>">
                    </div>
                      
                    <div class="form-group col-md-1">
                      <label for="nome">QUA</label>
                      <input type="text" class="form-control" name="matricula['falta_qua']" style="text-transform: uppercase;" value="<?php echo $matricula['falta_qua']; ?>">
                    </div>
                      
                    <div class="form-group col-md-1">
                      <label for="nome">AQUI</label>
                      <input type="text" class="form-control" name="matricula['falta_qui']" style="text-transform: uppercase;" value="<?php echo $matricula['falta_qui']; ?>">
                    </div>
                    
                    <div class="form-group col-md-1">
                      <label for="nome">SEX</label>
                      <input type="text" class="form-control" name="matricula['falta_sex']" style="text-transform: uppercase;" value="<?php echo $matricula['falta_sex']; ?>">
                    </div>
                    
                    <div class="form-group col-md-1">
                      <label for="nome">SAB</label>
                      <input type="text" class="form-control" name="matricula['falta_sab']" style="text-transform: uppercase;" value="<?php echo $matricula['falta_sab']; ?>">
                    </div>
                    
                    <div class="form-group col-md-1">
                      <label for="nome">DOM</label>
                      <input type="text" class="form-control" name="matricula['falta_dom']" style="text-transform: uppercase;" value="<?php echo $matricula['falta_dom']; ?>">
                    </div>
                </div>
