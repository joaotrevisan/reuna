...
CREATE TABLE matriculas (
  ...
  estado varchar(100) NOT NULL,
  falta_seg varchar(1) NOT NULL,
  falta_ter varchar(1) NOT NULL,
  falta_qua varchar(1) NOT NULL,
  falta_qui varchar(1) NOT NULL,
  falta_sex varchar(1) NOT NULL,
  falta_sab varchar(1) NOT NULL,
  falta_dom varchar(1) NOT NULL,    
